...
if($_COOKIE['cokuser_id']>0){
	setcookie('lograndval',$_COOKIE['lograndval'],$expire_time,'/');
	$_SESSION['lograndval']=$_COOKIE['lograndval'];
...
$insr_admind=$obj_db->get_qresult(INSERT_KEYWORD."   ".TABLE_LOGIN_HISTORY." SET  
 ...
 if($usrdt[0]['user_type']=='management' || $usrdt[0]['user_type']=='account' || $usrdt[0]['user_type']=='admins'){
   ...
   $decode_permislevels=json_decode($usrdt[0]['permission_levels'],true);
				   ...
				   $is_changeborowdate_permis=$decode_permislevels['is_changeborrowdate_permission'];
			  ...
			  $isdatpermis='';$datapermisvalidate='';$isfepaypermis='';$feepaypermisvaliddate='';$isconcessionpermis='';$concepermisvalidate=''; $ischangeborrowdatepermis='';$changeborrowdatepermisvalidate='';
			...
			// is_changeborowdate_permis,changeborrowdatepermisvaliddate  ischangeborrowdatepermis,changeborrowdatepermisvalidate is_changeborrowdate_permission,changeborrowdate_permis_validdte
           
			 if(($is_changeborowdate_permis==1 && strtotime($changeborrowdatepermisvaliddate)>=$todaydate && $changeborrowdatepermisvaliddate!='') || ($is_changeborowdate_permis==1 && $changeborrowdatepermisvaliddate=='')){
			  $ischangeborrowdatepermis=$decode_permislevels['is_changeborrowdate_permission'];
				   $changeborrowdatepermisvalidate=$decode_permislevels['changeborrowdate_permis_validdte'];
			 }
 ...
 $_SESSION['user_mobile']=$usrdt[0]['mobile'];
				$_SESSION['urlname']=$_COOKIE['cokurlname'];
					...
					$_SESSION['is_changeborrowdate_permission']=$ischangeborrowdatepermis;
...
$get_cuyr=$obj_db->qry("select * from ".TABLE_YEAR." where is_promote=0 ");
 ...
 $randid=rand();
  setcookie('lograndval',$randid,$expire_time,'/');
  $_SESSION['lograndval']=$randid;
...
<head>
   ...
   <style>
    body {
      ...
      align-items: center;
      height: 100vh;
      background: url("includes/images/bk.jpeg") no-repeat center center/cover; /* Change background here */
    }
...
<div class="container">
    <!-- Logo Section -->
    <div class="logo">
      <img src="includes/images/logo.jpeg" alt="Logo">
    </div>
    ...
    <div class="form">
     <div class="tabs">
        <span class="active">CENTRALIZED STORAGE</span>
