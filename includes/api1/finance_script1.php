<script>
 ...
 app.controller('opcashierwise_longtermreport', function($scope, $http) {		
          $scope.dat_range='<?php echo $_SESSION['dt'];?>';
         $scope.branch_id='<?php echo $_SESSION['angbranch_id'];?>';
            $http.get("../includes/api/finance_details.php?action=branch_dts")  
           .success(function(data){
...
app.controller('daily_totcolcamt', function($scope, $http) {		
		 ...
		 $scope.loading=true;
		  $(".cashierreport").hide();
            $http.get("../includes/api/finance_details.php?action=daily_totcolcamt")  
           .success(function(data){
		      console.log(data);
			  // $scope.dt=data.split('^');
	  ...
	  $scope.get_dailycollection = function(){  
		 $scope.loading=true;
		  $(".cashierreport").hide();
            $http.get("../includes/api/finance_details.php?action=daily_totcolcamt&branch_id="+$scope.branch_id+"&dat_range="+$scope.dat_range+"&course_id="+$scope.course_id)  
 ...
 app.controller("feeduesmsapi", function($scope, $http){
           ...
           $http.get("../includes/api/finance_details.php?action=get_branch_course_terms")  
           .success(function(data){ 
		   		console.log(data); 
	  ...
	  $scope.loading=true;
	  $(".feeduecolc").hide();
           $http.get("../includes/api/finance_details.php?action=std_fee_duesms&id="+i+"&branchid="+$scope.branchiddefault+"&terms="+$scope.term+"&course_id="+$scope.courseid)  
           .success(function(data){ 
		   		console.log(data); 
               $scope.fees = data;
			   $scope.loading = false; 
 ...
 app.controller("feedueapi", function($scope, $http){  
   ...
   $scope.loading=true;
     ...
     $http.get("../includes/api/finance_details.php?action=std_fee_due&branchid="+$scope.branchiddefault+"&ret_tots="+$scope.ret_tots+"&tot_count="+$scope.totalItems+"&fee_ids="+$scope.fee_ids+"&terms="+$scope.term+"&sec_id="+$scope.section+'&limit=' +$scope.pageSize)
