<?php defined('ACCESS_SUBFILES') or die('Restricted access');
			...
			$page_url="home.php?p=dailyevent_staff_assignedlist";
...
<div class="tab-header">
        ...
        <button id="downloadPdf" class="dropdown-item text-danger">
            <i  class="fa-solid fa-file-pdf me-2"></i> PDF
				...
				<form   class="form-horizontal needs-validation" novalidate id="frm1" method="post" enctype="multipart/form-data" action="<?php echo $page_url."&action=".$action.($id?"&id=".$id:"");?>">
				  ...
				  <h5 class="mb-3 border-bottom pb-2">Students Assigned List</h5>
    ...
    height="400">
     ...
     <?php $approvstatusarr=array(0=>'Pending',1=>'Approve',2=>'Reject');?>
                <div class="row justify-content-center">
					<div class="col-md-4">
          <label class="form-label">Score</label>
          <div class="input-group" style="flex-wrap: nowrap !important;">
            <input class=" fonrm-control fonrm-control-sm " type="text"  name="score" id="score">
          </div>
        </div>
          ...
          <div class="input-group" style="flex-wrap: nowrap !important;">
            <select class=" fonrm-control fonrm-control-sm "  name="approval_status" id="approval_status">
            <?php foreach($approvstatusarr as $approvky=>$approvval){?>
            <option value="<?php echo $approvky?>"><?php echo $approvval?></option>
            <?php }?>
...
<div align="center"  class="error customer_bordtcntmsg " id="customer_bordtcntmsg" style="color:red; font-size:14px; "></div>
        ...
        $usrdtsqry=$obj_db->qry("select * from ".TABLE_USER_DETAILS." where user_type_id=2 ");
        $assignusrrarr=array();
        foreach($usrdtsqry as $usrasky=>$usrasv)
          $assignusrrarr[$usrasv['user_id']]=$usrasv;
                            ...
                            <table id="contentToDownload" class="table align-middle text-dark small export-table tablesortsearchable">
                              <thead>
                                  ...
                                  <th data-sort="string">
                                   ...
                                   <th data-sort="string">
                                    <span class="sort-handle">AssignedTo <i class="fa-solid fa-sort sort-icon"></i></span>
                                  </th>
                                   <th data-sort="string">
